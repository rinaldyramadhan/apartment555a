		...
		<div class="card bg-light">
			<div class="card-header">
				<div class="row">
					...
					<div class="col-xl-10 text-right">
						<form action="<?php echo base_url('admin/laporan/cetak'); ?>" method="post" accept-charset="utf-8">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-xl-2 mt-3">
										<button  class="form-control btn btn-primary text-white" href="<?php echo base_url('admin/laporan/cetak'); ?>"><i class="fas fa-print"></i> Cetak</button>
			...
			<div class="card-body">
				<div class="table-responsive">	
					<table class="table table-sm table-hover text-dark text-center" id="dataTable">
							<thead>
								<tr>
									<th>ID Sewa</th>
									<th >Penyewa</th>
						...
						<?php endforeach ?>
								<tr>
									<td width="" colspan="9">Jumlah Total Harga</td>
									<td width="">Rp. <?php echo number_format($jumlahTotalHarga,0,'.','.') ?></td>
